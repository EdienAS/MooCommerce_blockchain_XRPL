...
class OrderRepository extends BaseRepository implements OrderRepositoryInterface
{
    ...
    public function listOrderedProducts() : Collection
    {
        return $this->model->products->map(function (Product $product) {
            ...
            $product->customer_owner_id = $product->pivot->customer_owner_id;
            $product->blockchain_nftid = $product->pivot->blockchain_nftid;
            $product->blockchain_nft_owner_wallet_seed = $product->pivot->blockchain_nft_owner_wallet_seed;
            $product->blockchain_nft_owner_wallet_address = $product->pivot->blockchain_nft_owner_wallet_address;
            $product->blockchain_nft_status = $product->pivot->blockchain_nft_status;
            return $product;
        });
    }
