    ...
    Route::namespace('Admin')->group(function () {
        Route::group(['middleware' => ['role:admin|superadmin|clerk, guard:employee']], function () {
            ...
            Route::namespace('Orders')->group(function () {
                ...
                Route::get('orders/warrenty/active/{id}/{product_id}', 'OrderController@warrenty_activate');
                Route::get('orders/warrenty/status/{id}/{product_id}', 'OrderController@warrenty_check');
            });

            Route::namespace('Warrenty')->group(function () {
                Route::resource('warrenty', 'WarrentyController');
                Route::post('warrenty/{id}', 'WarrentyController@update');
                Route::get('warrenty/{id}/status', 'WarrentyController@status');
            });
...
Route::namespace('Front')->group(function () {
    ...
    Route::get('/warrenty/card/{id}', 'AccountsController@generateWarrentyCard');
});