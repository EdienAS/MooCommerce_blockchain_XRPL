                        ...
                        <table class="table">
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->price }}</td>
                                    <td>
                                        @if ($item->blockchain_nft_status == 1)
                                            {{ "Active" }}
                                        @else
                                            @if ($item->blockchain_nft_status == 0)
                                                <a href="/admin/orders/warrenty/active/{{$order->id}}/{{$item->sku}}" id="activate_warrenty">Activate Warrenty</a>
                                            @else
                                                <a href="/admin/orders/warrenty/status/{{$order->id}}/{{$item->sku}}" id="activate_warrenty_status">Check Status</a>
                                            @endif
                                        @endif
                                    </td>
                                </tr>
