            ...
            <div class="box-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="col-md-4">Blockchain</td>
                    </tr>
                    </tbody>
                    <tbody>
                    <tr>
                        ...
                        <td>
                            @if($customer->blockchain_nftid)
                            <a title="Show Transaction" target="blank" href="https://testnet.xrpl.org/nft/{{$customer->blockchain_nftid}}">Show XRPL Block</a>
                            @else
                            N/A
                            @endif
                        </td>
