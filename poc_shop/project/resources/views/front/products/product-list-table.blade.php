                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <a href="{{ route('front.get.product', [$cartItem->product->slug]) }}" class="hover-border">
                                @if(isset($cartItem->cover))
                                    <img src="https://loremflickr.com/320/240/plants?v={{Illuminate\Support\Str::uuid()}}" alt="{{ $cartItem->name }}" class="img-responsive img-thumbnail">
                                @else
                                    <img src="https://loremflickr.com/320/240/plants?v={{Illuminate\Support\Str::uuid()}}" alt="" class="img-responsive img-thumbnail">
                                @endif
                            </a>
                        </div>
                    </div>
