...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="header">WARRENTY</li>
            <li class="treeview @if(request()->segment(2) == 'warrenty') active @endif">
                <a href="#">
                    <i class="fa fa-money"></i> <span>Warrenty</span>
                    <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.warrenty.index') }}"><i class="fa fa-circle-o"></i> List warrenty</a></li>
                </ul>
            </li>
