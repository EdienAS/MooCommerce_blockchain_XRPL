    ...
    <div class="col-md-6">
        @if (!empty($product->cover))
            <ul id="thumbnails" class="col-md-4 list-unstyled">
                <li>
                    <a href="javascript: void(0)">
                        <img class="img-responsive img-thumbnail" src="https://loremflickr.com/320/240/plants" alt="{{ $product->name }}" />
                    </a>
                </li>
                @if (isset($images) && !$images->isEmpty())
                    @foreach ($images as $image)
                        <li>
                            <a href="javascript: void(0)">
                                <img class="img-responsive img-thumbnail" src="https://loremflickr.com/320/240/plants" }}"
                                    alt="{{ $product->name }}" />
                            </a>
                        </li>
                    @endforeach
            ...
            <figure class="text-center product-cover-wrap col-md-8">
                <img id="main-image" class="product-cover img-responsive" src="https://loremflickr.com/400/400/plants?w=400"
                    data-zoom="https://loremflickr.com/1200/1200/plants?w=1200">
            </figure>
        @else
            <figure>
                <img src="https://loremflickr.com/320/240/plants" alt="{{ $product->name }}"
